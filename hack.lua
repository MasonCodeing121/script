...
local function FireRemote()
    ...
    print("Completed 1000 'GainMuscle' fires within FireRemote.")
end
...
print("Starting the FOREVER loop. This will continuously fire 1000 'GainMuscle' events per cycle.")

-- The 'while true do' loop runs the code block forever
while true do
    print("\n--- Starting new cycle of " .. numberOfCycles .. " blocks of 1000 fires ---")
    
    -- Inner loop to run the FireRemote function 'numberOfCycles' times
    for cycle = 1, numberOfCycles do
        -- Calling FireRemote executes 1000 fires internally
        FireRemote() 
